package luxmart_backend.logging;
...
public class AspectLogging {
    ...
    @Pointcut("execution(* luxmart_backend.services.impl.ProductServiceImpl.getProductById(..))")
    ...
    @Pointcut("execution(* luxmart_backend.services.impl.ProductServiceImpl.getAllProducts(..))")
